...
hist(s_de[ ,10], breaks = 25, main = paste("Log2 Fold Change of all Genes"),col = c("cyan"), xlab = paste("Log2 Fold Change"))


#Subsetting sig to "yes" and into a histogram
sig_de <- subset(s_de, significant == "yes")
hist(sig_de[ ,10],breaks = 25, main = paste("Log2 Fold Change of Significant Genes"),col = c("cyan"), xlab = paste("Log2 Fold Change"))


#Saving histograms to jpeg
